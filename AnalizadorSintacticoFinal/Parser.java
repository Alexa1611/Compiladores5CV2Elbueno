...
public class Parser {
    ...
    void declaracion() {
        ...
        if (preanalisis.equals(classK)) {
            ...
            declaracion();
                ...
                preanalisis.equals(nullK) || preanalisis.equals(thisK) || preanalisis.equals(numberK)
    ...
    void state_decl() {
        ...
        if (preanalisis.equals(ifK)) {
            ...
            block();
        } else if (preanalisis.equals(diferente) || preanalisis.equals(menos) || preanalisis.equals(trueK)
                || preanalisis.equals(falseK) ||
                preanalisis.equals(nullK) || preanalisis.equals(thisK) || preanalisis.equals(numberK)
                || preanalisis.equals(cadenaK) ||
                preanalisis.equals(id) || preanalisis.equals(parentesisIzq) || preanalisis.equals(superk)) {
    ...
    void for_stms2() {
        ...
        if (preanalisis.equals(diferente) || preanalisis.equals(menos) || preanalisis.equals(trueK)
                || preanalisis.equals(falseK) ||
                preanalisis.equals(nullK) || preanalisis.equals(thisK) || preanalisis.equals(numberK)
                || preanalisis.equals(cadenaK) ||
                preanalisis.equals(id) || preanalisis.equals(parentesisIzq) || preanalisis.equals(superk)) {
    ...
    void block_decl() {
        if (hayErrores)
            return;
        if (preanalisis.equals(classK) || preanalisis.equals(funK) || preanalisis.equals(varK)
                || preanalisis.equals(diferente) || preanalisis.equals(menos) || preanalisis.equals(trueK)
                || preanalisis.equals(falseK) || preanalisis.equals(nullK) ||
                preanalisis.equals(thisK) || preanalisis.equals(numberK) || preanalisis.equals(cadenaK)
                || preanalisis.equals(id) ||
                preanalisis.equals(parentesisIzq) || preanalisis.equals(superk) || preanalisis.equals(forK)
                || preanalisis.equals(ifK) || preanalisis.equals(printK) ||
